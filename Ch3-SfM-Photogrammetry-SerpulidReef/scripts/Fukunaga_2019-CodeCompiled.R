...
dir = "C:\\Users\\jcmontes\\Documents\\GitHub\\ant_biogenic_structures\\data\\quadrats"
setwd(dir)
...
write.csv(hab_data, "C:\\Users\\jcmontes\\Documents\\GitHub\\ant_biogenic_structures\\data\\habitat-metrics-16-32.csv", row.names = FALSE)
